...
def main_decentralized(no_targets,no_observers,targets,observers,threshold):
	step=0
	count=0
	data_until_update=[]
...
count_new=main_decentralized(no_targets,no_observers,targets,sorted_observers,0.3)
print(count_new)
