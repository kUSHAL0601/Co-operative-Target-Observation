			...
			for l in target_speed:
				...
				if((j,l) in d12):
					if(mo1):
						...
						d13[(j,l)].append((mo3-mo1)/mo1)
					if(mo2):
						d21[(j,l)].append((mo1-mo2)/mo2)
						d23[(j,l)].append((mo3-mo2)/mo2)
					if(mo3):
						d31[(j,l)].append((mo1-mo3)/mo3)
						d32[(j,l)].append((mo2-mo3)/mo3)
				else:
					if(mo1):
						d12[(j,l)]=[(mo2-mo1)/mo1]
						d13[(j,l)]=[(mo3-mo1)/mo1]
...
plt.legend()
plt.title("Comparing strategy 1 to 2")

plt.figure(2)
plt.xlabel("No. of targets")
plt.ylabel("Mean diffrence between strategies")
plt.legend()
plt.title("Comparing strategy 2 to 1")

plt.figure(3)
plt.xlabel("No. of targets")
plt.ylabel("Mean diffrence between strategies")
plt.legend()
plt.title("Comparing strategy 1 to 3")

plt.figure(4)
plt.xlabel("No. of targets")
plt.ylabel("Mean diffrence between strategies")
plt.legend()
plt.title("Comparing strategy 3 to 1")

plt.figure(5)
plt.xlabel("No. of targets")
plt.ylabel("Mean diffrence between strategies")
plt.legend()
plt.title("Comparing strategy 2 to 3")

plt.figure(6)
plt.xlabel("No. of targets")
plt.ylabel("Mean diffrence between strategies")
plt.legend()
plt.title("Comparing strategy 3 to 2")

plt.figure(1)
plt.savefig("Obst1-Obst2.png")
plt.figure(2)
plt.savefig("Obst2-Obst1.png")

plt.figure(3)
plt.savefig("Obst1-Obst3.png")
plt.figure(4)
plt.savefig("Obst3-Obst1.png")

plt.figure(5)
plt.savefig("Obst2-Obst3.png")
plt.figure(6)
plt.savefig("Obst3-Obst2.png")
