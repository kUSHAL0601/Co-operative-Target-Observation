...
class hetero_main_1:
	...
	def cmp(self):
		...
		strategy1=strat1()
		t1=strategy1.run(no_targets,no_observers,no_obstacles,targets,observers,obstacles)
		strategy2=strat2()
		t2=strategy2.run(no_targets,no_observers,no_obstacles,targets,observers,obstacles)
		strategy3=strat3()
		t3=strategy3.run(no_targets,no_observers,no_obstacles,targets,observers,obstacles)
		strategy4=strat4()
		t4=strategy4.run(no_targets,no_observers,no_obstacles,targets,observers,obstacles)
